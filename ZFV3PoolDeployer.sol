...
contract ZFV3PoolDeployer is IZFV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @param factory The contract address of the ZF V3 factory
    ...
    function deploy(
        ...
        pool = address(new ZFV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
